...
public class ExampleViews {
    ...
    public static final ResourceLocation EXAMPLE_NESTED_TABS_VIEW_ID = ResourceLocation.fromNamespaceAndPath(GelatinUi.MOD_ID, "example/nested_tabs");
    ...
    public static final List<ResourceLocation> EXAMPLE_VIEWS = List.of(
            ...
            EXAMPLE_MANUAL_CONTAINER_VIEW_ID, EXAMPLE_NESTED_TABS_VIEW_ID);
}
