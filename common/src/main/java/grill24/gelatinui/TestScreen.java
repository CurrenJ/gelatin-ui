...
//                .scaleToFit(true);
    ...
    private void cycleAlignment() {
        ...
        textVBox.markDirty(grill24.gelatinui.gui.DirtyFlag.LAYOUT);
    }
    ...
    private void cycleOuterAlignment() {
        ...
        outerVBox.markDirty(grill24.gelatinui.gui.DirtyFlag.LAYOUT);
...
//        drawPerformanceInfo(guiGraphics);
    ...
    protected void drawPerformanceInfo(GuiGraphics guiGraphics) {
        ...
        boolean bounds = grill24.gelatinui.gui.UIElement.isDebugBoundsEnabled();
        boolean grid = grill24.gelatinui.gui.UIElement.isDebugGridEnabled();
        boolean pad = grill24.gelatinui.gui.UIElement.isDebugPaddingEnabled();
